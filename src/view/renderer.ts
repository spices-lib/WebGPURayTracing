import shader from '/shaders/shaders.wgsl?url&raw'
...
export class Renderer {
    ...
    async createAssets() {
        ...
        await this.triangleMaterial.initialize(this.device, "./images/chat.jpg", this.materialGroupLayout)
        await this.quadMaterial.initialize(this.device, "./images/floor.jpg", this.materialGroupLayout)
    }
